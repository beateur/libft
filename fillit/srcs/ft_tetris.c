...
/*   Updated: 2019/01/03 19:47:07 by bihattay         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		void const *content, size_t content_size)
{
	...
	if (!(elem = (t_tetris *)malloc(sizeof(t_tetris))) && ft_inc(&combien))
		return (NULL);
	if (!(elem->content = (void*)ft_memalloc(content_size + 1)) && ft_inc(&combien))
		return (NULL);
	elem->id = id;
